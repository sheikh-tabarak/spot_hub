...
class AppColors {
  static final Color darkBackgroundColor = const Color(0xFF000000);
  static final Color lightBackgroundColor = const Color(0xFFFFFFFF);
  static final Color PrimaryColor = const Color(0xFFEF4C2F);
  static final Color SecodaryColor = const Color(0xFFEA9430);

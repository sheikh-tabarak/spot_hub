...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    return _isLoading==true?Loading(message: "Deleting your chat"):Scaffold(
      extendBody: true,
      appBar: AppBar(
                ...
                child: InkWell(
                  onTap: () async {
                    if (_ChatMessageController.text != "") {
                      await sendMessage(
                          widget.ChatUserId, _ChatMessageController.text);
                    } else {
                      Fluttertoast.showToast(msg: "Type something to send");
                    }
                    setState(() {

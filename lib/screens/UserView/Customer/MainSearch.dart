...
class MainSearch extends StatefulWidget {
  ...
  const MainSearch({super.key, required this.Results});
            ...
            child: SingleChildScrollView(
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return ProductCard(
                          products: FoodItem(
                            isRecommended: DummyProducts[filteredIndexes.elementAt(index)].isRecommended,
                              BussinessId: DummyProducts[filteredIndexes.elementAt(index)].BussinessId,
                              Id: DummyProducts[filteredIndexes.elementAt(index)].Id,
                              image: DummyProducts[filteredIndexes.elementAt(index)].image,
                              description: DummyProducts[filteredIndexes.elementAt(index)].description,
                              title: DummyProducts[filteredIndexes.elementAt(index)].title,
                              Price: DummyProducts[filteredIndexes.elementAt(index)].Price,
